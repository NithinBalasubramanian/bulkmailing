            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">List Customer</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List Customer Form </h4>
                                    ...
                                    <table id="zero_config" class="table  table-bordered no-wrap">
                                        ...
                                        <tbody>
                                         <?php $session=$this->session->userdata('user_data'); ?>
                                            <?php $customer_list=$this->Admin_model->table_column('cus_management','user_id',$session['user_id'],'status','1');
                                            ...
                                            <tr id="row_<?php echo $cus_row['id']; ?>">
                                                ...
                                                <td><a href="<?php echo base_url(); ?>View_admin/customer_management/edit_customer/<?php echo $cus_row['id']; ?>" class="btn btn-sm btn-info">Edit</a>
<a href="javascript:void(0)" class="btn btn-danger btn-sm switchery" data-rowid="<?php echo $cus_row['id']; ?>" >Delete</a></td>
