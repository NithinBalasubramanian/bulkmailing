...
<div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Add Customer</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <form class="form-horizontal" action="<?php echo base_url(); ?>Insert/cus_management/customer_management/add_customer/list_customer" method="post" enctype="multipart/form-data" >
