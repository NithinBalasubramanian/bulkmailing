...
<div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Team</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Team</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Edit Team</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <form class="form-horizontal" action="<?php echo base_url(); ?>admin/Update_all/team/team/<?php echo $edit_id; ?>/list_team/list_team" method="post" enctype="multipart/form-data" >
            <?php $profile=$this->Admin_model->table_column('team','id',$edit_id);
            if(count($profile) > 0)
            {
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name="des" id="" class="form-control" id="inputEmail3" value="<?php echo $row['des']; ?>">
                  </div>
                </div>
                </div>
                <div class="row">
