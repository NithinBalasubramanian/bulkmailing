...
<div class="page-wrapper">
           ...
           <form class="form-horizontal" action="<?php echo base_url(''); ?>Admin/Edit_setting/terms/settings/terms" method="post" enctype="multipart/form-data" >
       <?php $data=$this->Admin_model->table_column('terms'); 
        foreach($data as $row){ ?>
             <div class="box-body">
            <div class="row justify-content-center ">
                <div class="form-group col-md-8">
                <label>Terms and conditions</label>
                 <textarea type="text" name="terms" class="form-control"><?php echo $row['terms']; ?></textarea>
                 </div>
              </div>
